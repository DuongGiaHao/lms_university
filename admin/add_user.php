...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute($params)) {
        ...
        $message = "<div class='alert alert-danger'>Add user failed!</div>";
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Add User - University LMS</title>
...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div class="card mb-4">
                <div class="card-header bg-success text-white"><i class="fas fa-user-plus"></i> Add User</div>
                <div class="card-body">
